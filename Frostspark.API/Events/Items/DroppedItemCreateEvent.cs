...
{
    public abstract class DroppedItemCreateEvent : DroppedItemEvent, ICancellable
    {
        public DroppedItemCreateEvent(DroppedItem item, API.Server server) : base(item, server)
        {
